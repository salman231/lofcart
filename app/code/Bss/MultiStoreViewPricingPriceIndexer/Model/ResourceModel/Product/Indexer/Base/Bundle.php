 ...
 */
namespace Bss\MultiStoreViewPricingPriceIndexer\Model\ResourceModel\Product\Indexer\Base;

use Magento\Catalog\Api\Data\ProductInterface;

class Bundle extends \Bss\MultiStoreViewPricingPriceIndexer\Model\ResourceModel\Product\Indexer\Price\DefaultPrice
{
    /**
     * @inheritdoc
     */
    ...
    protected function _prepareTierPriceIndex($entityIds = null)
    {
        ...
        $select = $connection->select()->from(
            ...
            ['e.entity_id', 'cg.customer_group_id', 'cs.store_id']
        );
